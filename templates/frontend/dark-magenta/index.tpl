					...
					<div class="well well-sm">
						<a href="{$relative}/video/{$viewed_videos[i].VID}/{$viewed_videos[i].title|clean}">
							<div class="thumb-overlay">
								...
								<img src="{$viewed_videos[i].thumb_img}" title="{$viewed_videos[i].title|escape:'html'}" alt="{$viewed_videos[i].title|escape:'html'}" id="rotate_{$viewed_videos[i].VID}_{$viewed_videos[i].thumbs}_{$viewed_videos[i].thumb}_viewed" class="img-responsive {if $viewed_videos[i].type == 'private'}img-private{/if}"/>
				...
				<div class="col-sm-4 col-md-3 col-lg-3">
					<div class="well well-sm">
						<a href="{$relative}/video/{$recent_videos[i].VID}/{$recent_videos[i].title|clean}">
							<div class="thumb-overlay">
								<img src="{$recent_videos[i].thumb_img}" title="{$recent_videos[i].title|escape:'html'}" alt="{$recent_videos[i].title|escape:'html'}" id="rotate_{$recent_videos[i].VID}_{$recent_videos[i].thumbs}_{$recent_videos[i].thumb}_recent" class="img-responsive {if $recent_videos[i].type == 'private'}{/if}"/>
