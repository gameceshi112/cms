...
<div class="video-container">
	<video id="video" class="video-js vjs-16-9 vjs-big-play-centered vjs-sublime-skin" preload="auto" controls poster="{$video.thumb_img}" {if $player.autoplay}{literal}data-setup='{"autoplay": true}'{/literal}{else}{literal}data-setup='{}'{/literal}{/if}>
		{if $video.iphone == 1}
