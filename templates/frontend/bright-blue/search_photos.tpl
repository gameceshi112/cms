	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-4">
			<div class="list-group">
				<a href="{url base='search/photos' strip='c' value=''}" {if $category == "0"}class="list-group-item active"{else}class="list-group-item"{/if}>
					{t c='global.all'}
				</a>
				{section name=i loop=$categories}
				<a href="{url base=search/photos/`$categories[i].slug` strip='c' value=''}" {if $category == $categories[i].CID}class="list-group-item active"{else}class="list-group-item"{/if}>
					{$categories[i].name}
				</a>
				{/section}
			</div>
