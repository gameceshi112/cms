									...
									<table class="table-radio">
										<tbody>
											...
											<tr>
												...
												<td class="v-align-middle">
													<div class="radio radio-success">
														 <input type="radio" {if $video_embed == '1'}checked="checked"{/if} value="1" name="video_embed" id="video_embed_e">
														 <label class="m-0" for="video_embed_e">Enabled</label>
													</div>												
												</td>
												<td class="v-align-middle">
													<div class="radio radio-danger">
														<input type="radio" {if $video_embed == '0'}checked="checked"{/if} value="0" name="video_embed" id="video_embed_d">
											...
											<tr>
												...
												<td class="v-align-middle">
													<div class="radio radio-success">
														 <input type="radio" {if $gzip_encoding == '1'}checked="checked"{/if} value="1" name="gzip_encoding" id="gzip_encoding_e">
														 <label class="m-0" for="gzip_encoding_e">Enabled</label>
													</div>												
												</td>
												<td class="v-align-middle">
													<div class="radio radio-danger">
														<input type="radio" {if $gzip_encoding == '0'}checked="checked"{/if} value="0" name="gzip_encoding" id="gzip_encoding_d">
											...
											<tr>
												...
												<td class="v-align-middle">
													<div class="radio radio-success">
														 <input type="radio" {if $approve_games == '1'}checked="checked"{/if} value="1" name="approve_games" id="approve_games_e">
														 <label class="m-0" for="approve_games_e">Enabled</label>
													</div>												
												</td>
												<td class="v-align-middle">
													<div class="radio radio-danger">
														<input type="radio" {if $approve_games == '0'}checked="checked"{/if} value="0" name="approve_games" id="approve_games_d">
								...
								<div class="col-md-6">
									...
									<div class="row">
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input type="text" name="games_per_page" value="{$games_per_page}" class="form-control {if $err.games_per_page}error{/if}">
											</div>
											<div class="clearfix"></div>
										</div>
									</div>
