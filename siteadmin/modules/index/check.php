...
$directory[]['path'] = '/media/categories/game';
$directory[]['path'] = '/media/categories/video';
$directory[]['path'] = '/media/csv';
$directory[]['path'] = '/media/games/swf';
$directory[]['path'] = '/media/games/tmb';
$directory[]['path'] = '/media/games/tmb/orig';
...
$file[]['path'] = '/templates/emails/game_approve.tpl';
$file[]['path'] = '/templates/emails/game_comment.tpl';
$file[]['path'] = '/templates/emails/game_upload.tpl';
...
$file[]['path'] = '/templates/emails/share_game.tpl';
