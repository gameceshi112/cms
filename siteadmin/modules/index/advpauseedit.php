...
if ( isset($_POST['adv_edit']) && !$errors ) {
    ...
    if ( !$errors ) {
        $sql            = "UPDATE adv_pause SET
								  name = '" .mysql_real_escape_string($adv['name']). "', 
								  code = '" .mysql_real_escape_string($adv['code']). "', 
                                  device = '" .mysql_real_escape_string($adv['device']). "', 
                                  categories = '" .mysql_real_escape_string($adv['categories']). "', 
								  status = '" .mysql_real_escape_string($adv['status']). "' 
