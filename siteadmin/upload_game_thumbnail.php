...
Auth::checkAdmin();
    ...
    $filter   = new VFilter();
	$GID = $filter->get('game-thumbnail-id', 'INT');
...
?>
<script language="javascript" type="text/javascript">window.top.window.stopUpload(<?php echo $GID ?>, <?php echo $addthumb ?>);</script>