...
$sql            = "SELECT VID, title, duration,thumb_img, addtime, thumb, thumbs, viewnumber, rate, likes, dislikes, type, hd
...
$sql            = "SELECT VID, title, duration, addtime, thumb_img,thumb, thumbs, viewnumber, rate, likes, dislikes, type, hd
