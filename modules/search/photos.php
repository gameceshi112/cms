...
if ( $search_query ) {
    $sql_add        .= " AND ( name LIKE '%" .mysql_real_escape_string($search_query). "%' OR tags LIKE '%" .mysql_real_escape_string($search_query). "%' )";
    $sql_add_count  .= " AND ( name LIKE '%" .mysql_real_escape_string($search_query). "%' OR tags LIKE '%" .mysql_real_escape_string($search_query). "%' )";
}
