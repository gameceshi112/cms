...
if ( $gender ) {
    $title_g        = ' ' .$gender;
    $sql_add       .= " AND u.gender = '" .mysql_real_escape_string($gender). "'";
    $sql_add_count .= " AND u.gender = '" .mysql_real_escape_string($gender). "'";
}

if ( $interest ) {
    $sql_add       .= " AND u.interested = '" .mysql_real_escape_string($interest). "'";
    $sql_add_count .= " AND u.interested = '" .mysql_real_escape_string($interest). "'";
}
